...
export default function RegisterPage() {
  return (
    <main className="relative min-h-screen flex items-center justify-center bg-[#0C0E14] overflow-hidden px-6 py-12">
      {/* Orbs mesh gradient */}
      <div
        className="animate-orb pointer-events-none fixed -right-[20%] -top-[20%] w-[65%] h-[65%] rounded-full"
        style={{ background: "radial-gradient(circle, rgba(163,255,18,0.2) 0%, transparent 70%)" }}
      />
      <div
        className="animate-orb-alt pointer-events-none fixed -left-[15%] -bottom-[15%] w-[55%] h-[55%] rounded-full"
      ...
      <div
        ...
        style={{ background: "radial-gradient(circle, rgba(163,255,18,0.05) 0%, transparent 65%)" }}
      />
