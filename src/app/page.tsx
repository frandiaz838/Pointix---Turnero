...
import { ArrowRight, CreditCard, MessageCircle, Link2, Sparkles, Zap, ChevronRight, Check } from "lucide-react"
import { MacBookMockup, IPhoneMockup } from "@/components/landing/device-mockups"
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-toxic-gradient text-white relative overflow-x-hidden">
      ...
      {/* Panel de admin — mockups iPhone + MacBook side-by-side */}
      <section className="relative z-10 max-w-7xl mx-auto px-6 py-20 sm:py-28">
        ...
        <div className="text-center mb-14 sm:mb-16">
          ...
          >
            Mirá todo desde<br />
            <span className="text-white/30">cualquier dispositivo.</span>
          </h2>
          <p className="text-white/55 text-base sm:text-lg mt-6 max-w-2xl mx-auto leading-relaxed">
            Ingresos del día, ocupación por cancha, próximas reservas — todo a un click, desde tu compu o el celular. Sin planillas, sin Excel.
          </p>
        </div>
        ...
        <div className="relative">
          <div
            className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-[80%] blur-3xl opacity-30 pointer-events-none"
            style={{
              background: "radial-gradient(ellipse at 50% 50%, rgba(163,255,18,0.35) 0%, transparent 65%)",
            }}
          />

          <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-6 items-center">

            {/* MacBook (8 cols en desktop) */}
            <div className="lg:col-span-8 lg:order-1 order-2">
              <MacBookMockup />
            </div>

            {/* iPhone (4 cols en desktop) */}
            <div className="lg:col-span-4 lg:order-2 order-1 flex justify-center">
              <IPhoneMockup />
            </div>
